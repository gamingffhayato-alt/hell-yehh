            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mono mt-1.5 text-[11px] tracking-[-0.01em] text-slate-400 dark:text-slate-500">Standard text input only</p>
                </div>
                <div>
                  <Label>Gender</Label>
